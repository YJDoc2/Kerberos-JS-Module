...
export default class KerberosKDC {
   ...
   * lifetimems is lifetime of ticket in milliseconds
  ...
  genAuthTickets(
    ...
    return this.AS.makeAuthTickets(rand, cUid1, cUid2, user, lifetimeMs);
  }
  ...
  // requires a perticular type of request structure which is passed as encrypted in reqEncStr.
